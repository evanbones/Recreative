...
You can rename them, change their icon, remove specific items, or inject new items into them. You can also target specific NBT variants (like enchanted books or potions)!
